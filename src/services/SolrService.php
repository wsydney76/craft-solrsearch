...
class SolrService extends Component
{
    ...
    public function init()
    {
        ...
        $baseUrl = Craft::parseEnv($settings->solrBaseUrl);
        $core = Craft::parseEnv($settings->solrCore);
        ...
        $this->_queryUrl = $coreUrl . '/select';
        $this->_updateUrl = $coreUrl . '/update';
        parent::init();
    }
    ...
    public function reload()
    {
        ...
        $url = Craft::parseEnv($settings->solrBaseUrl) . '/admin/cores?action=RELOAD&core=' . Craft::parseEnv($settings->solrCore);
